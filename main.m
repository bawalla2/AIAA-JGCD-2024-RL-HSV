...
%
% B. A. Wallace, J. Si, "Reinforcement Learning Control of Hypersonic 
% Vehicles and Performance Evaluations" AIAA JGCD, 2024 (In Review).
%
%
% ***** PROGRAM EXECUTION FLOW:
%
% * Select preset group to execute (see variable 'preset_group_list'
...
% corresponding to the number of preset groups executed (only 1 preset
% group allowed for this program). Each entry of these cell arrays contains
% data for the respective preset group of the form.
%
...
%
% Uncomment a preset group to execute it. 
% 
% NOTE: Only uncomment 1 group at a time.
%
% *************************************************************************
...
preset_group_list = {   
%
%       *** FREQUENCY RESPONSE EVALUATION GROUPS   
%                                 'freq_resp_sweep_CL'
%                                 'freq_resp_sweep_CD'
%                                 'freq_resp_sweep_CMa'
%       *** STEP VELOCITY EVALUATION GROUPS
                                'ES_nom_step_V'
%                                 'ES_error_step_V_CL_10pct'
%                                 'ES_error_step_V_CL_25pct'
%                                 'ES_error_step_V_CD_10pct'
%                                 'ES_error_step_V_CD_25pct'
%                                 'ES_error_step_V_CMa_10pct'
%                                 'ES_error_step_V_CMa_25pct'    
%       *** STEP FPA EVALUATION GROUPS
%                                 'ES_nom_step_g'
%                                 'ES_error_step_g_CL_10pct'
%                                 'ES_error_step_g_CL_25pct'
%                                 'ES_error_step_g_CD_10pct'
%                                 'ES_error_step_g_CD_25pct'
%                                 'ES_error_step_g_CMa_10pct'
%                                 'ES_error_step_g_CMa_25pct'
%       *** IC SWEEP GROUPS
...
%                                 'ES_error_eval_sweep_rand_nu_step_V' 
%                                 'ES_error_eval_sweep_rand_nu_step_g' 
%       *** STATIC AND DYNAMIC ANALYSIS GROUPS
%                                 'stat_dyn_sweep_CL_CD'
%                                 'stat_dyn_sweep_CL_CMa'
%                                 'stat_dyn_sweep_CD_CMa'
};
...
for i = 1:numgroups
    ...
    if ~group_settingsi.dolearning && group_settingsi.runpresets
        ...
        issweep_dEIRL = isfield(dirl_data, 'out_data_cell_master');
